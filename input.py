...
# ------------------------------------------------------------------------------
	...
	file = 'request.xlsx'									# Request file
	firewall_backup_folder = 'c:/users/al202t/desktop/data/'# Folder where firewall backup stored
	# sheet_name = 'individual'
	sheet_name = 'exact_grp_del'

	# STEP2: Initialize Request and Firewall inputs ----------------------
	Req = Request(file, sheet_name)
